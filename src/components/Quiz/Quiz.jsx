         ...
         <ul>
            {
               choices.map((answer, index) => (
                  <li
                     ...
                     key={answer} className={answerIdx === index ? 'selected-answer' : null}>
                     {answer}
   ...
   return (
      <div className="quiz-container">
         {!showResult ? (<>
            ...
            <span className="active-question-no">{currentQuestion + 1}


            </span>
            <span className="total-question">/{questions.length}
